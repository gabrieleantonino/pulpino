...
board_setup();
  ...
  ee_printf("Going to sleep and wait for interrupts now\n");
...
/*void ISR_GPIO(void) {
  ...
  switch(get_gpio_irq_status()) {
    case 1 << 16: ee_printf("Enter pressed\n"); break;
    case 1 << 17: ee_printf("Down pressed\n");  break;
    case 1 << 18: ee_printf("Left pressed\n");  break;
    case 1 << 19: ee_printf("Right pressed\n"); break;
    case 1 << 20: ee_printf("Up pressed\n");    break;
    default:      ee_printf("Unknown GPIO\n");  break;
  }
}*/
void board_setup() {
  int i;
